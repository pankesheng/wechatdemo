...
<html>
  ...
  <script type="text/javascript">
	var order = '${orderNo}';
	function pay(){
		window.location.href="<%= request.getContextPath() %>/wxpay/paymain.ajax?orderNo="+order+"&userId=124124&descr=是多少分开就害臊低级房哈市的金凤凰驾驶的恢复了卡号第十六课了可视电话&money=0.01";		
	}
	
	function aaaa(){
		window.location.href="<%= request.getContextPath() %>/wxpay/oauth.ajax";
	}
